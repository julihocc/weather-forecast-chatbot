...
class WeatherCondition:
    ...
    def __repr__(self):
        return (
            f"WeatherCondition(temp_min: {self.temp_min}, "
...
def get_text_weather_date(
    ...
    try:
        ...
        text_message_tpl = (
            "The weather of {text_city} for {text_date} ({date}) is {status}, "
            "it's tempterpure range is：{temp_min}℃-"
        )
        text_message_tpl += "{temp_max}℃."
